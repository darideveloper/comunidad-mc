...
class TestModels (TestCase):
    ...
    def test_donation (self):
        ...
        self.assertEqual (donation.__str__(), "test_user - 10 bits (sample auth)")
...
class TestAdmin (TestCase):
    ...
    def setUp (self):
        ...
        content_type_donations = ContentType.objects.get_for_model (models.Donation)
        
        permissions = []
        permissions += Permission.objects.filter (content_type=content_type_user)        
        permissions += Permission.objects.filter (content_type=content_type_donations)
